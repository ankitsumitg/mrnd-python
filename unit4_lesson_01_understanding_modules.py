...
def test_module_without_import():
    try:
        module1.greet("jack")
    except NameError :   # what specific exception did you get here, replace ___ with that
        print("Name Error")    # print it out and see
        assert True
...
-How modules work
-changing values inside the modules
-Errors raised using modules
"""
