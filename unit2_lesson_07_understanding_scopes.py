...
def test_scope_undefined_variable():
    ...
    except Exception as e : # fill up the exception
        pass
    x = ('name' in global_names)
...
def test_scope_is_bound_at_definition_time():
    ...
    try:
        value = count
        count = 30
    except Exception as e: # what happens when you read a variable before initializing it?
        print(e) #uncomment after you fill up above
        assert True
    finally:
        count = 20
    x = get_global_count()
...
-scope and lifetime of an variable
-how to mange these variables
-
"""
