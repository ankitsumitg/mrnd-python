...
def test_numbers_arithmetic_operations():
    assert 30 == 10 + 20
    assert 200 == 10 * 20
    assert 32 == 2 ** 5     # this may be new for you #power function 2^5
    assert -10 == 10 - 20
    assert 2 == 6/3
    ...
    #>>> import math
    #>>> help(math.isclose)
    assert math.isclose(2.33, 7/3, abs_tol=0.1), "fix abs_tol so that this assert passes"
