...
def get_execution_time(func):
    ...
    for i in counts:
        ...
        print(", ".join([func.__name__,"count = "+str(i), "min = {}".format(min(timings)), "actuals = {}".format(timings)]))


def profile_perf_counter():
    funcs = [unit8_conversion_methods.numbers_string1, unit8_conversion_methods.numbers_string2,
